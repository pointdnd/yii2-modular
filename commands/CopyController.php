...
// Use
// php yii copy --from=@vendor/amnah/yii2-user --to=@app/modules/user --namespace=app\\modules\\user
namespace mii\commands\controllers;
use Yii;
...
class CopyController extends Controller
{
     ...
     */
    public $from = "@vendor/mii/yii2-modular/modules/users";
    /**
     * @var string To path
     */
    public $to = "@app/modules/users";
    /**
     * @var string New namespace of module
     */
    public $namespace = "app\\modules\\users";
    /**
     * @inheritdoc
     */
    ...
    protected function copyFiles($fromPath, $toPath, $namespace)
    {
        ...
        foreach ($filePaths as $file) {
            ...
            $content = str_replace("mii\\modules\\users", $namespace, $content);
