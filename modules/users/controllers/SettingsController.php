...
class SettingsController extends Controller
{
    ...
    public function actionProfile()
    {
        ...
        if ($model->load(\Yii::$app->request->post()) && $model->save()) {
            \Yii::$app->getSession()->setFlash('success', \Yii::t('users', 'Profile settings have been successfully saved'));
            return $this->refresh();
        }
    ...
    public function actionAccount()
    {
        ...
        if ($model->load(\Yii::$app->request->post()) && $model->save()) {
            \Yii::$app->session->setFlash('success', \Yii::t('users', 'Account settings have been successfully saved'));
            return $this->refresh();
        }
