...
<div class="jumbotron text-center">
  <div class="container profile-lanscape">
  </div>
</div>
...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="row">
            <div class="col-sm-6 col-md-4 profile-avatar">
                ...
                <ul style="padding: 0; list-style: none outside none;">
                    ...
                    <?php endif; ?>
                    <li><i class="glyphicon glyphicon-time text-muted"></i> <?= Yii::t('users', 'Joined on {0, date}', $profile->user->created_at) ?></li>
                </ul>
